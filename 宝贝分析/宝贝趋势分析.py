...
class Assert_test(unittest.TestCase):
    ...
    listsevenmoney = driver.find_element_by_xpath(
        "/html/body/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[3]/table/tbody/tr[6]/td[7]/div/span").get_attribute(
        "textContent").strip().replace('w', '')
    print(listsevenmoney)

    listthirtymoney = driver.find_element_by_xpath(
        "/html/body/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[3]/table/tbody/tr[6]/td[9]/div/span").get_attribute(
        "textContent").strip().replace('w', '')
    ...
    listsevenamount = driver.find_element_by_xpath(
        "/html/body/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[3]/table/tbody/tr[6]/td[8]/div").get_attribute(
        "textContent")
    print(listsevenamount)

    listthirtyamount = driver.find_element_by_xpath(
        "/html/body/div[2]/div[2]/div[2]/div/div/div/div[2]/div/div/div[3]/table/tbody/tr[6]/td[10]/div").get_attribute(
        "textContent")
    ...
    toolsevenmoney = driver.find_element_by_xpath(
        "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[1]/p[2]/span").get_attribute(
        "textContent").strip().replace('w', '')
    print(toolsevenmoney)

    toolthirtymoney = driver.find_element_by_xpath(
        "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[2]/div[3]/div[1]/p[2]/span").get_attribute(
        "textContent").strip().replace('w', '')
    ...
    toolsevenamount = driver.find_element_by_xpath(
        "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[2]/div[2]/div[2]/p[2]").get_attribute(
        "textContent").strip().replace(' ', '')
    print(toolsevenamount)

    toolthirtyamount = driver.find_element_by_xpath(
        "/html/body/div[2]/div[2]/div[2]/div/div[2]/div[2]/div[3]/div[2]/p[2]").get_attribute(
        "textContent").strip().replace(' ', '')
